...
### Tests are skipped
- **Unit/E2E**: Should never be skipped (check pytest output)
- **Integration**: Requires `--run-integration` flag and environment variables
...
### Sliver connection errors
```bash
# Check Sliver is running
