...
class SliverClient(BaseClient):
    ...
    async def generate_stage(
        ...
        aes_encrypt_iv: str = "",
        rc4_encrypt_key: str = "",
        prepend_size: bool = False,
        compress_f: str = "",
        compress: str = "",
        timeout: int = 360
    ) -> client_pb2.Generate:
        """Generate a staged implant

        :param profile: The name of the C2 profile to use
        :type profile: str
        :param name: The name of the implant
        :type name: str
        :param aes_encrypt_key: AES encryption key (optional)
        :type aes_encrypt_key: str
        :param aes_encrypt_iv: AES encryption IV (optional)
        :type aes_encrypt_iv: str
        :param rc4_encrypt_key: RC4 encryption key (optional)
        :type rc4_encrypt_key: str
        :param prepend_size: Whether to prepend size to the stage
        :type prepend_size: bool
        :param compress_f: Compression format (optional)
        :type compress_f: str
        :param compress: Compression algorithm (optional)
        :type compress: str
        :param timeout: gRPC timeout, defaults to 360
        :type timeout: int, optional
        :return: Protobuf Generate object containing the generated stage
        :rtype: client_pb2.Generate
        """
        req = client_pb2.GenerateStageReq(
            ...
            AESEncryptIv=aes_encrypt_iv,
            RC4EncryptKey=rc4_encrypt_key,
            PrependSize=prepend_size,
            CompressF=compress_f,
            Compress=compress
        )
        return await self._stub.GenerateStage(req, timeout=timeout)
