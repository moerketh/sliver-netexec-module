...
class _OutputFormatEnumTypeWrapper(_EnumTypeWrapper[_OutputFormat.ValueType], type):  # noqa: F821
...
class _StageProtocolEnumTypeWrapper(_EnumTypeWrapper[_StageProtocol.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _FileTypeEnumTypeWrapper(_EnumTypeWrapper[_FileType.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _ShellcodeEncoderEnumTypeWrapper(_EnumTypeWrapper[_ShellcodeEncoder.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _HTTPC2SegmentTypeEnumTypeWrapper(_EnumTypeWrapper[_HTTPC2SegmentType.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _HashTypeEnumTypeWrapper(_EnumTypeWrapper[_HashType.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _StatesEnumTypeWrapper(_EnumTypeWrapper[_States.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _CrackJobStatusEnumTypeWrapper(_EnumTypeWrapper[_CrackJobStatus.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _CrackAttackModeEnumTypeWrapper(_EnumTypeWrapper[_CrackAttackMode.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _CrackEncodingEnumTypeWrapper(_EnumTypeWrapper[_CrackEncoding.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _CrackOutfileFormatEnumTypeWrapper(_EnumTypeWrapper[_CrackOutfileFormat.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _CrackWorkloadProfileEnumTypeWrapper(_EnumTypeWrapper[_CrackWorkloadProfile.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class _CrackFileTypeEnumTypeWrapper(_EnumTypeWrapper[_CrackFileType.ValueType], type):  # noqa: F821
    DESCRIPTOR: EnumDescriptor
...
class ImplantConfig(Message):
    ...
    DebugFile: str
    @property
    def exports(self) -> RepeatedScalarFieldContainer[str]: ...
...
class HTTPC2ImplantConfig(Message):
    ...
    HEADERS_FIELD_NUMBER: int
    MAXFILEGEN_FIELD_NUMBER: int
    MINFILEGEN_FIELD_NUMBER: int
    MAXPATHGEN_FIELD_NUMBER: int
    MINPATHGEN_FIELD_NUMBER: int
    MAXPATHLENGTH_FIELD_NUMBER: int
    MINPATHLENGTH_FIELD_NUMBER: int
    EXTENSIONS_FIELD_NUMBER: int
    PATHSEGMENTS_FIELD_NUMBER: int
    NONCEQUERYLENGTH_FIELD_NUMBER: int
    NONCEMODE_FIELD_NUMBER: int
    ID: str
    UserAgent: str
    ...
    def ClearField(self, field_name: typing_extensions.Literal["ChromeBaseVersion", b"ChromeBaseVersion", "ExtraURLParameters", b"ExtraURLParameters", "Headers", b"Headers", "ID", b"ID", "MacOSVersion", b"MacOSVersion", "MaxFileGen", b"MaxFileGen", "MaxPathGen", b"MaxPathGen", "MaxPathLength", b"MaxPathLength", "MinFileGen", b"MinFileGen", "MinPathGen", b"MinPathGen", "MinPathLength", b"MinPathLength", "NonceMode", b"NonceMode", "NonceQueryArgChars", b"NonceQueryArgChars", "NonceQueryLength", b"NonceQueryLength", "PathSegments", b"PathSegments", "UserAgent", b"UserAgent", "extensions", b"extensions"]) -> None: ...
...
class HTTPC2PathSegment(Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["ID", b"ID", "IsFile", b"IsFile", "Value", b"Value"]) -> None: ...
